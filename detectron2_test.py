...
### Try Training Detectron2 on new dataset
...
for d in ["train", "val"]:
    f = lambda d=d: get_balloon_dicts("./Data/balloon/" + d)
    DatasetCatalog.register("balloon_" + d, f)
...
dataset_dicts = get_balloon_dicts("./Data/balloon/val")
for d in random.sample(dataset_dicts, 3):
